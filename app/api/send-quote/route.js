...
export async function POST(req){
 try{
  ...
  const er=await fetch('https://api.resend.com/emails',{method:'POST',headers:{Authorization:`Bearer ${key}`,'Content-Type':'application/json'},body:JSON.stringify({from:FROM_EMAIL,to:[r.email],subject:`Ultimate Wrenchworks quote — ${r.year_make_model}`,html})});
