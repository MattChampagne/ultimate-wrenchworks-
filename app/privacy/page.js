...
export default function PrivacyPolicy(){
  return <main style={pageStyle}><article style={cardStyle}>
    ...
    <p style={pStyle}>We do not sell or share your SMS opt-in data or personal information with third parties for marketing purposes. We may use service providers that process communications or business data on our behalf solely to operate our services.</p>
