...
export default function Home() {
  return (
    <main>
      ...
      <section className="schedule" id="schedule"><p className="kicker">READY TO GET STARTED?</p><h2>LET’S GET YOU<br/>BACK IN MOTION.</h2><p>Tell us what you’re working with and what it’s doing. We’ll follow up to confirm the service details and scheduling.</p><a className="primary light" href="mailto:service@ultimatewrenchworks.com?subject=Service%20Request">Request an Appointment</a><p className="note">A $100 diagnostic fee may apply to diagnostic service.</p></section>
