...
export default function Home() {
  return (
    <main>
      ...
      <section className="section" id="services"><p className="kicker">WHAT WE WORK ON</p><h2>ONE MOBILE SHOP.<br/>MORE WAYS TO KEEP MOVING.</h2><div className="grid">{services.map(([title, text])=><article className="card" key={title}><h3>{title}</h3><p>{text}</p><a href="#schedule">Request service →</a></article>)}</div></section>
